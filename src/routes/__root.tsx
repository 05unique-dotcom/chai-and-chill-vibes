  ...
  head: () => ({
    meta: [
      ...
      { title: "Chai & Chill — Authentic Indian Street Food" },
      {
        name: "description",
        content:
          "Order cutting chai, vada pav, samosas, and poha from Chai & Chill. Mumbai-style street food, made with love since 1985.",
      },
      { name: "author", content: "Chai & Chill" },
      ...
      { name: "twitter:site", content: "@chaiandchill" },
    ],
    links: [
      {
        rel: "stylesheet",
